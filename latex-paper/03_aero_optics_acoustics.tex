...
In Figure \ref{fig:03_spherical_plot}, measured wavefronts are compared to the wavefronts simulated using the method described in Section \ref{chap:03_simulated_beam} for the highest excitation cases at each frequency.
\begin{figure}
  \centering
