...
\end{figure}
The lines here represent the solutions to Equation \ref{eqn:02_kzm} for a series of cross-sectional acoustic modes.
...
\end{equation}
The effective horizontal wavenumber, which is related to the spatial frequency via $\xi_x = k^\pm_{hm}/2\pi$.
Figure \ref{fig:04_dispersion_sound_angle} shows the acoustic duct mode lines at at Mach number of 0.6 over a range of beam angles.
\begin{figure}
  \centering
