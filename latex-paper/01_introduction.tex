...
A review of the available literature and important concepts are given in Chapter \ref{chap:02_lit_review}.
...
Multi-dimensional spectral techniques will be used to analyze optical wavefronts in Chapter \ref{chap:04_dispersion} and to filter optical wavefronts in Chapter \ref{chap:06_single_filter}, as well as looking at a filtering technique which makes use of additional sensor data from microphones and accelerometers to remove optical contamination.
Chapter \ref{chap:07_multiple_filter} will look at the combination of some of the various filtering methods examined in Chapter \ref{chap:06_single_filter}.
