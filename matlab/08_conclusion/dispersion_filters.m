...
title('Forward Filter','Interpreter','Latex');
view(-45,15);
material dull;
camlight;
...
ylabel('$\xi_y$','Interpreter','Latex');
zlabel('$f$','Interpreter','Latex');
title('F+V+B Filter','Interpreter','Latex');
view(-45,15);
material dull;
camlight;
...
legend('No Filter','Forward Filter','Velocity Filter','Baseline Filter','F+V+B Filter','interpreter','latex');
