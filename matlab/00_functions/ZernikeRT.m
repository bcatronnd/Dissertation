function [rho,theta] = ZernikeRT(mask,max_r)
%ZERNIKERT Generates the rho and theta matrices from a mask for phase
%screen
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% DESCRIPTION:
% Generates the rho and theta matrices from a mask for phase screen.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% INPUTS:
%   mask [array]: Mask or phase screen .
%   max_r [scalar]: Maximum radius of output. Default = 1;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% OUTPUTS:
...
% VERSION:
% 1.0 - 12 SEP 2019
% 1.1 - 18 SEP 2019 - Error in theta calc
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
x(mask==0) = 0;
y(mask==0) = 0;
[center,radius] = minboundcircle(x(x~=0),y(y~=0));
rho = sqrt((x-center(1)).^2+(y-center(2)).^2)/radius*max_r;
