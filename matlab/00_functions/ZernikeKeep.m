function [phase_screen] = ZernikeKeep(j,phase_screen,rho,theta,scheme,epsilon)
%ZERNIKEREMOVAL Keeps the j Zernike modes from the phase screen.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% DESCRIPTION:
% Keeps the j Zernike modes from the phase screen.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% INPUTS:
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% OUTPUTS:
% phase_screen [array] = Wavefront/phase screen array with kept modes
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% REFERENCES:
...
if strcmp(scheme,'annular')
    ...
    phase_screen = ZernikeReconstruct(j,ZernikeCoefficient(j,phase_screen,rho,theta,scheme,epsilon),rho,theta,scheme,epsilon);
else
    phase_screen = ZernikeReconstruct(j,ZernikeCoefficient(j,phase_screen,rho,theta,scheme),rho,theta,scheme);
end
end
